      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="p-5 rounded-2xl border border-rose-500/30 bg-rose-500/5 space-y-3">
          <div className="flex items-center justify-between pb-2 border-b border-rose-500/20">
            ...
            <Badge
              variant="outline"
              className="font-mono text-[9px] bg-rose-500/10 text-rose-700 border-rose-500/20"
            >
              Area to Correct
            </Badge>
          </div>
          <ul className="space-y-2 text-xs text-muted-foreground">
            {review.losses.map((loss, idx) => (
              <li key={idx} className="flex items-start gap-2">
                <span className="font-mono text-[10px] text-rose-600 font-bold shrink-0 mt-0.5">
                  ✗
                </span>
                <span>{loss}</span>
              </li>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="p-5 rounded-2xl border border-sky-500/30 bg-sky-500/5 space-y-3">
          <div className="flex items-center justify-between pb-2 border-b border-sky-500/20">
            ...
            <Badge
              variant="outline"
              className="font-mono text-[9px] bg-sky-500/10 text-sky-700 border-sky-500/20"
            >
              TAM Gap
            </Badge>
          </div>
          <ul className="space-y-2 text-xs text-muted-foreground">
            {review.missedOpportunities.map((op, idx) => (
              <li key={idx} className="flex items-start gap-2">
                <span className="font-mono text-[10px] text-sky-600 font-bold shrink-0 mt-0.5">
                  ?
                </span>
                <span>{op}</span>
              </li>
          ...
          <div className="space-y-1 text-xs">
            <div className="flex justify-between">
              ...
              <span className="font-bold text-foreground">
                {review.campaignSummary.activeCount}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">Top Channel:</span>
              <span className="font-bold text-foreground">
                {review.campaignSummary.topPerformingChannel}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">Conversion Rate:</span>
              <span className="font-bold text-emerald-600">
                {review.campaignSummary.conversionRate}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 rounded-2xl border border-[#E5E0D6] bg-background space-y-2">
          ...
          <div className="space-y-1 text-xs">
            <div className="flex justify-between">
              ...
              <span className="font-bold text-foreground">
                {review.contentPerformance.totalImpressions}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">Engagement Rate:</span>
              <span className="font-bold text-emerald-600">
                {review.contentPerformance.engagementRate}
              </span>
            </div>
            <p className="text-[10px] text-muted-foreground truncate pt-0.5">
              Top: {review.contentPerformance.topPostTitle}
            </p>
          </div>
        </div>
        ...
        <div className="p-4 rounded-2xl border border-[#E5E0D6] bg-background space-y-2">
          ...
          <div className="space-y-1 text-xs">
            <div className="flex justify-between">
              ...
              <span className="font-bold text-foreground">
                {review.pipelineHealth.totalPipelineValue}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">New Deals:</span>
              <span className="font-bold text-emerald-600">
                +{review.pipelineHealth.newQualifiedDeals}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">Win Rate:</span>
              <span className="font-bold text-foreground">{review.pipelineHealth.winRate}</span>
            </div>
          </div>
        </div>
      </div>
